...
def setup_module(module):
    ...
    shutil.copyfile('fixtures/larkm.json.tests_privateshoulder_unauthorized_ip', 'larkm.json')
...
def test_resolve_non_http_target_from_unregistered_address():
    ...
    # If the value of "target" does not start with "http", larkm returns a 403.
