...
def setup_module(module):
    ...
    shutil.copyfile(
        "fixtures/index_dir/MAIN_40us1wxonicoi7js.seg.bak",
        "fixtures/index_dir/MAIN_40us1wxonicoi7js.seg",
    )
...
def test_create_ark():
    ...
    assert response.json() == {
        ...
        "urls": {
            "local": "https://resolver.myorg.net/ark:99999/s114b7f127-b358-4994-8888-5b7392f588d7",
    ...
    response = client.post(
        ...
        json={
            "naan": "22222",
            "shoulder": "s1",
            "identifier": "9e2e1275-9dfc-4966-a865-652690678cb2",
    ...
    assert response.json() == {
        "ark": {
            "shoulder": "s1",
            "identifier": "9e2e1275-9dfc-4966-a865-652690678cb2",
            "ark_string": "ark:22222/s19e2e1275-9dfc-4966-a865-652690678cb2",
            "target": "https://example.com/uuytr",
            "who": ":at",
            "what": ":at",
            "when": ":at",
            "where": "ark:22222/s19e2e1275-9dfc-4966-a865-652690678cb2",
            "policy": "ACME University commits to maintain ARKs that have 's1' as a shoulder for a long time.",
        },
        "urls": {
            "local": "https://resolver.myorg.net/ark:22222/s19e2e1275-9dfc-4966-a865-652690678cb2",
            "global": "https://n2t.net/ark:22222/s19e2e1275-9dfc-4966-a865-652690678cb2",
        },
    }
    ...
    assert response.json() == {
        "ark": {
            ...
            "what": "A new ARK",
            "when": ":at",
            "where": "ark:99999/x920578b9e-ba6e-494b-b35d-1419e06f9ced",
            "policy": "Default committment statement.",
        },
        "urls": {
            "local": "https://resolver.myorg.net/ark:99999/x920578b9e-ba6e-494b-b35d-1419e06f9ced",
    ...
    assert response.json() == {
        "ark": {
            ...
            "when": ":at",
            "what": "A test ARK with some 'special' characters (`%&) in its metadata",
            "where": "ark:99999/x947321e02-7df6-4dfc-aad2-bdb75ab6b92b",
            "policy": "Default committment statement.",
        },
        "urls": {
            "local": "https://resolver.myorg.net/ark:99999/x947321e02-7df6-4dfc-aad2-bdb75ab6b92b",
    ...
    assert (
        response.text
        == '{"detail":"Provided UUID cda60df9-b468-4520-8e97-fc12deb5e324x is invalid."}'
    )
    ...
    assert response.json() == {
        "detail": "UUID 2d24d07f-ed23-4613-a7a3-0c46155c191f already in use."
    }
        ...
        "arks": [
            {
                ...
                "shoulder": "s1",
                "identifier": "a0925880-1268-4059-980b-155f9d2ff02a",
                ...
                "erc_when": ":at",
                "erc_where": "ark:99999/s1a0925880-1268-4059-980b-155f9d2ff02a",
            ...
            },
            {
                ...
                "date_modified": "2022-06-23 03:00:45",
                "shoulder": "s1",
                "identifier": "a09d74a2-3e06-4d5a-9282-fc82c43a984a",
                ...
                "erc_when": ":at",
                "erc_where": "ark:99999/s1a09d74a2-3e06-4d5a-9282-fc82c43a984a",
...
def test_update_ark():
    ...
    assert response.json() == {
        "ark": {
            ...
            "what": ":at",
            "when": ":at",
            "where": "ark:99999/s2cda60df9-b468-4520-8e97-fc12deb5e324",
            "policy": "Default committment statement.",
        },
        "urls": {
            "local": "https://resolver.myorg.net/ark:99999/s2cda60df9-b468-4520-8e97-fc12deb5e324",
    ...
    assert response.json() == {
        "ark": {
            ...
            "what": "New ARK with its own policy",
            "when": ":at",
            "where": "ark:99999/s2aaed59b0-6ad6-4b69-8511-bcf781e386a0",
            "policy": "A test policy.",
        },
        "urls": {
    ...
    response = client.put(
        ...
        json={"ark_string": "ark:99999/s23a8a9396-baa8-46be-ba22-b08b0de2db5bxxx"},
    )
    assert response.status_code == 409
    assert response.json() == {
